...
For example:
- If "FOO" is given, replace the content of the line with FOO.
- If "FOO\\n" is given, insert a new line after FOO. The addresses of the consequent lines are not changed.
- If "FOO\\nBAR" is given, replace the line with the 2 lines. The addresses of the consequent lines are not changed.
- If "" is given, replace the line with an empty line.
